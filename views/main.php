...
<html lang="ru" class="no-js">
    ...
    <body class="it-did-not-work">
        ...
        <!-- /.ac-header-->
        <?php require('main-block/_whatformats.html'); ?>
        <!-- .ac-wefine-->
