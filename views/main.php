                    ...
                    <div class="step-block">
                        ...
                        <div class="step-block__description">
                            <div class="step-block__description-head">
                                ...
                                <h2 class="step-block__head">Менеджер в течение суток составляет для вас медиаплан с перечнем площадок, их описанием, форматами размещений. И присылает на согласование.</h2>
                            </div>
                            <div class="step-block__description-text">
